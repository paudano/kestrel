 ...
 */
public class ReferenceReaderInitException extends Exception {
	 ...
	 */
	public ReferenceReaderInitException(String msg) {
		super(msg);
	 ...
	 */
	public ReferenceReaderInitException(String msg, Throwable cause) {
		super(msg, cause);
